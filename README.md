...
- 📋 **Сортировка таблицы** - клик на заголовок для сортировки по любой колонке
- 📄 **Копирование в буфер** - клик на название карты/предмета для копирования
- 🔗 **Trade ссылки** - быстрый переход на официальный trade сайт PoE
- 🔄 **Кнопка обновления** списка лиг
- ✨ **Визуальные эффекты** - hover, tooltip, анимации
...
- **[WEB_FEATURES.md](WEB_FEATURES.md)** ⭐ **НОВОЕ** - Полное руководство по функциям веб-интерфейса
...
- **Сортировка**: Кликните на любой заголовок колонки для сортировки
- **Копирование**: Кликните на название карты или предмета для копирования в буфер обмена
- **Trade**: Нажмите 🔍 рядом с предметом для поиска на официальном trade сайте
- **Лиги**: Автоматическая загрузка актуальных лиг (кнопка 🔄 для обновления)

Подробнее см. **[WEB_FEATURES.md](WEB_FEATURES.md)**
